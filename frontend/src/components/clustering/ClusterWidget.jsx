    ...
    <div>
      <h2 className="section-title" style={{ justifyContent: 'space-between' }}>
        ...
        >
          ...
          <span id="txt-recluster">{isReclustering ? 'Ejecutando IA...' : 'Regenerar Grupos'}</span>
        </button>
      </h2>
      <Card>
        {previewClusters.length > 0 ? (
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', textAlign: 'center', padding: '1rem' }}>
            Haz clic en "Regenerar Grupos" para que K-Means agrupe las notas en PostgreSQL.
          </p>
        )}
